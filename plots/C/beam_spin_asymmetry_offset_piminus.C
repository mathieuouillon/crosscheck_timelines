...
//=========  (Fri Mar 21 11:35:46 2025) by ROOT version 6.30/04
   ...
   Double_t Graph_fx1004[3] = { 18335, 18774, 18535 };
   Double_t Graph_fy1004[3] = { 0.003932621, -0.0003505828, 0.006488095 };
   Double_t Graph_fex1004[3] = { 0, 0, 0 };
   Double_t Graph_fey1004[3] = { 0.01012497, 0.005468496, 0.00517209 };
   TGraphErrors *gre = new TGraphErrors(3,Graph_fx1004,Graph_fy1004,Graph_fex1004,Graph_fey1004);
   gre->SetName("");
   gre->SetTitle("");
   gre->SetFillStyle(1000);
   
   TH1F *Graph_Graph1004 = new TH1F("Graph_Graph1004","",100,18291.1,18817.9);
