...
//=========  (Wed Apr 30 14:35:23 2025) by ROOT version 6.30/04
   ...
   c1->Range(-7.894737,-4751523,7.894737,3.484451e+07);
   c1->SetFillColor(0);
   c1->SetBorderMode(0);
   c1->SetBorderSize(2);
   ...
   hs_stack_2->SetMaximum(3.009298e+07);
   ...
   chi2_e_stack_1->SetBinContent(100,2.865998e+07);
   chi2_e_stack_1->SetEntries(2.865998e+07);
   ...
   chi2_e_cut_stack_2->SetBinContent(100,2.865998e+07);
   chi2_e_cut_stack_2->SetEntries(2.865998e+07);
   ...
   hs->Draw("nostack");
   TLine *line = new TLine(-3,0,-3,2.292799e+07);
   line->SetLineColor(98);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(3,0,3,2.292799e+07);
   line->SetLineColor(98);
   line->SetLineWidth(2);
   line->Draw();
   c1->Modified();
