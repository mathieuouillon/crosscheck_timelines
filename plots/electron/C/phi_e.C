...
//=========  (Wed Apr 30 14:35:23 2025) by ROOT version 6.30/04
   ...
   c1->Range(-250,-4751523,250,3.484451e+07);
   c1->SetFillColor(0);
   c1->SetBorderMode(0);
   c1->SetBorderSize(2);
   ...
   hs_stack_3->SetMaximum(3.009298e+07);
   ...
   phi_e_stack_1->SetBinContent(128,2.865998e+07);
   phi_e_stack_1->SetEntries(2.865998e+07);
   ...
   phi_e_cut_stack_2->SetBinContent(128,2.865998e+07);
   phi_e_cut_stack_2->SetEntries(2.865998e+07);
